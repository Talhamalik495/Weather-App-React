  ...
  let search = async () => {
    try {
      ...
      if (input) {
        ...
        setIcon("");
        setTemp("");
        setError("Input Fields Fill Please");
      }
  ...
  return (
    <>
      <div className="w-[100%] py-20 flex justify-center flex-col">
        ...
        <div className=" w-[35%] rounded-xl mt-5 bg-[rgba(0,0,0,0.3)] mx-auto flex justify-center flex-col align-middle items-center py-10">
          ...
          <div className="felx">
            <div className="flex  flex-col pt-2">
              {error ? <h1 className="pt-10 text-white">{error}</h1> : ""}
              <div className="flex just ify-center items-center text-white text-3xl">
                <img
                  className=" ml-24 min-h-0 max-h-36 max-w-36"
                  src={icon}
                  alt=""
                />
              </div>
